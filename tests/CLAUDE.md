...
| `test_startup_selector.py` | `StartupSelector` — market-cap filtering, non-interactive auto-selection, interactive prompt with limit enforcement | `AsyncMock` providers + `patch("sys.stdin")` |
